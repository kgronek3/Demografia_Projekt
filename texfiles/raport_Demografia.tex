...
\addbibresource{bibliografia_Demografia.bib}

\input{inputfiles/formatowanie}
\input{inputfiles/options}

\begin{document}

\input{inputfiles/strona_tytulowa}
\input{inputfiles/streszczenie}
